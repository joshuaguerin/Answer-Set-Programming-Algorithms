...
### CNF Satisfiability
One of the most common forms of the SAT problem is CNF satisfiability. In CNF satisfiability a *clause* is a statement comprised of variables joined together by `or` operators. E.g., (&not;`a` &or; `c` &or; `d`).
